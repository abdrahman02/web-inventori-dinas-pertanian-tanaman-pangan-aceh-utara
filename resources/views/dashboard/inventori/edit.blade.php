                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="text" class="form-control @error('merk') is-invalid @enderror"
                                        placeholder="Merk" id="merk" name="merk" required
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="text" class="form-control @error('bahan') is-invalid @enderror"
                                        placeholder="Bahan" id="bahan" name="bahan" required
                                        value="{{ old('bahan', $item->bahan) }}">
                                    @error('bahan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="text" class="form-control @error('tgl_perolehan') is-invalid @enderror"
                                        ...
                                        autocomplete="off" value="{{ old('tgl_perolehan', $item->tgl_pereolehan) }}">
                                    @error('tgl_perolehan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="text" class="form-control @error('kap_barang') is-invalid @enderror"
                                        ...
                                        value="{{ old('kap_barang', $item->kap_barang) }}">
                                    @error('kap_barang')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
